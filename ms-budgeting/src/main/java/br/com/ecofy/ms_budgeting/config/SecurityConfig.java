...
public class SecurityConfig {
    ...
    // Ajuste para o path real do ms-budgeting (ex.: /api/budgets/**, /api/budgeting/** etc.)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        log.info("[SecurityConfig] - [securityFilterChain] -> Configurando HTTP security para ms-budgeting (LOCAL DEV MODE)");
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers(BUDGETING_API_ENDPOINTS).permitAll()

                                // PROD MODE (com token) — DESCOMENTE para exigir JWT
//                        .requestMatchers(BUDGETING_API_ENDPOINTS).authenticated()
